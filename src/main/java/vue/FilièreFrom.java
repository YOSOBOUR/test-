 ...
 * @author Yo Sobour
 */
public class FilièreFrom extends javax.swing.JFrame {

    /**
     * Creates new form FilièreFrom
     */
    public FilièreFrom() {
        initComponents();
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(AFFICHER, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(70, 70, 70)
    ...
    private void AFFICHERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AFFICHERActionPerformed
        ...
        FiliereForm AA = new FiliereForm();
        AA.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FilièreFrom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FilièreFrom().setVisible(true);
            }
        });
    }
